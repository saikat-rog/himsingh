    ...
    >
      <div className="transition duration-200 group-hover/bento:translate-x-2">
        <div className="font-sans text-xs font-normal text-neutral-600 dark:text-neutral-300">
          <p>{description}</p>
          <div className=" flex flex-row items-center gap-1 mt-2 mb-2 font-sans font-bold text-neutral-600 dark:text-neutral-200">
            <img src={image} alt="" className="h-6 lg:h-7" />
