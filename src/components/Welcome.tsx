...
const Welcome = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center w-full px-4 lg:px-16 py-10 lg:py-20 space-y-10 lg:space-y-0">
      {/* Left part */}
      <div className="w-full lg:w-2/3 flex justify-center items-center">
        <div className="relative w-full max-w-lg h-72 sm:h-96 rounded-lg overflow-hidden">
      ...
      <div className="w-full lg:w-1/3 flex flex-col text-center items-center space-y-5 px-4">
        <h1 className="text-secondary text-xl sm:text-2xl md:text-3xl font-semibold">
