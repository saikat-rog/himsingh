...
const CTAButton = ({text}: CTAButtonProps) => {
  return (
    <a href="#courses" className="flex flex-row justify-center items-center bg-white rounded-full p-1.5 lg:p-2 mb-5 hover:scale-105 transition-transform duration-500 ease-in-out shadow-2xl shadow-secondary"
>
